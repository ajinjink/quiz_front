...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-4xl w-full px-4">
                    <div className="text-center">
                        ...
                        <div className="space-y-4">
                            <button 
                                className="w-full max-w-md py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700" 
                                onClick={() => isAuthenticated ? navigate('/dashboard') : navigate('/signup')}
                            >
                                {isAuthenticated ? "대시보드로 이동하기" : "나만의 스터디 버디 만들러 가기"}
                            </button>
                            <button className="w-full max-w-md py-3 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50">
                                인기 퀴즈 보러 가기
                            </button>
                        </div>
                    </div>
            ...
            <footer className="mt-auto bg-gray-100 py-6 mt-20">
